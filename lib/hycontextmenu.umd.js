(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["hycontextmenu"] = factory();
	else
		root["hycontextmenu"] = factory();
...
;// CONCATENATED MODULE: ./src/package/menu.js

let menu_containers = [];
let current_theme = 'default';
function createRightMenu(x, y, menu_items, theme = 'default', level = 0, type = 'right_click') {
  popMenu(level);
    ...
    if (menu_containers.length > 0) {
      ...
      for (let i = 0; i < menu_containers.length; i++) {
        ...
        const {
          ...
          left,
          right
        } = menu_container.getBoundingClientRect();
...
function resizeMenu() {
  ...
  const {
    right,
    bottom
  } = last_menu.el.getBoundingClientRect();
  if (right > window_width) {
    for (let i = 0; i < menu_containers.length; i++) {
      const {
        left
      } = menu_containers[i].el.getBoundingClientRect();
...
;// CONCATENATED MODULE: ./src/origin.js
...
/* harmony default export */ var origin = (install);
;// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js


/* harmony default export */ var entry_lib = (origin);
...
//# sourceMappingURL=hycontextmenu.umd.js.map